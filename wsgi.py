...
class Midterm(object):
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def spur1(self, N1=70, N2=60, N3=50, N4=40, N5=30, N6=20, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def spuraction1(self, N1=70, N2=60, N3=50, N4=40, N5=30, N6=20, M=5, P=15):
        output = '''
        <!doctype html><html>
        <head>
        <meta http-equiv="content-type" content="text/html;charset=utf-8">
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspur1(self, N1=70, N2=60, N3=50, N4=40, N5=30, N6=20, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspuraction1(self, N1=70, N2=60, N3=50, N4=40, N5=30, N6=20, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
